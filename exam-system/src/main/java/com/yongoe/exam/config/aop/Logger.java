...
public class Logger {
     ...
     */
    @Pointcut("execution(* com.yongoe.exam..controller.*.*(..))")
    public void pt() {
    }
     ...
     * 注解Log切面
     */
    @Pointcut("@annotation(com.yongoe.exam.config.aop.WebLog)")
